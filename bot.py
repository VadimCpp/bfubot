...
def mo2_message(message):
    bot.send_message(message.chat.id, 'Во вторник с 15-20 до 16-50 лекция по Питону, в 231 аудитории.\nВ среду:\nу первой подгруппы практика по Питону с 13-40 до 15-10, в 230 аудитории;\nу второй подгруппы практика по Птиону с 10-10 до 11-40, в 235 аудитории;\nу третьей подгруппы практика по Питону с 12-00 до 13-30 в 235 аудитории.')
