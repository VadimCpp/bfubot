...
jsonString_pm4='{ "Group": "ПМ-4", "TimeTable":{"Day":[  {"DayName":"Пятница", "Подгруппа":[{"Номер":"(1я подгруппа)", "time":"10-10", "Cab":"ауд. 230А. Вход через 230 ауд.", "Lesson": "лаба Python"},{"time":"12-00", "Cab":"(ауд.118)", "Lesson": "лекция Pythonaaaa"},{"Номер":"(2я подгруппа)", "time":"13-40", "Cab":"ауд. 214", "Lesson": "лаба Python"} ]} ]} }'
